...
<body>
	...
	<xsl:for-each select="file">
	    <xsl:for-each select="violation">
			...
			<td style="padding: 3px" align="left"><xsl:value-of disable-output-escaping="yes" select="@ruleset"/></td>
			<td style="padding: 3px" align="left"><xsl:value-of disable-output-escaping="yes" select="@package"/>.<xsl:value-of select="@class"/></td>
			<td style="padding: 3px" align="right"><a><xsl:attribute name="href">txmt://open?url=file://<xsl:value-of disable-output-escaping="yes" select="../@name"/>&amp;line=<xsl:value-of disable-output-escaping="yes" select="@beginline"/></xsl:attribute><xsl:value-of disable-output-escaping="yes" select="@beginline"/></a></td>
